...
function normalizeTokenCount(value: any): number {
  const numericValue = Number(value);
  if (!Number.isFinite(numericValue) || numericValue <= 0) return 0;
  return Math.round(numericValue);
}

function normalizeUsdAmount(value: any): number | null {
  const numericValue = Number(value);
  if (!Number.isFinite(numericValue) || numericValue < 0) return null;
  return Number(numericValue.toFixed(6));
}

function calculateTokenCostUsd(tokenCount: number, usdPer1M: any): number {
...
export function createAiRunRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createAiCostPolicyRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createPromptTemplateRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createStyleProfileRecord(payload: any = {}, ownershipContext: any = {}) {
...
export async function saveAiRun(record: any) {
...
export async function updateAiRun(id: string, updates: any) {
  const db = getFirestore();
