...
export const HARDWARE_COLLECTIONS = Object.freeze({
...
export const INVENTORY_ITEM_STATUSES = Object.freeze([
  "IN STOCK",
  "SOLD",
  "REPAIR",
  "RESERVED",
...
export const ITEM_RELATIONSHIP_TYPES = Object.freeze([
  "compatible",
  "substitute",
  "maintenance_related",
  "cross_sell",
...
function normalizeUpperToken(value: any) {
...
function normalizeCount(value: any, fallback = 0) {
...
export function buildCatalogItemCanonicalKey(payload: any = {}) {
  return [
    payload.type,
    payload.brand,
    payload.model,
...
export function createCatalogItemRecord(payload: any = {}, ownershipContext: any = {}) {
  return buildBaseRecord("catalog_item", {
    ...
    quantityAvailable:
      payload.quantityAvailable != null
        ...
        : Math.max(
          normalizeCount(payload.quantityOnHand, 0) - normalizeCount(payload.quantityReserved, 0),
          0,
        ),
...
export function createInventoryItemRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createInstalledBaseRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createMaintenanceRuleRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function createItemRelationshipRecord(payload: any = {}, ownershipContext: any = {}) {
...
export function canRecommendItemRelationship(relationship: any = {}) {
  if (!relationship?.allowedForRecommendation) return false;
  if (!relationship?.isSupportedByBusiness) return false;
