...
exports.AI_RUN_STATUSES = exports.AI_RUN_COLLECTIONS = void 0;
exports.estimateAiRunCost = estimateAiRunCost;
exports.createAiRunRecord = createAiRunRecord;
exports.createAiCostPolicyRecord = createAiCostPolicyRecord;
exports.createPromptTemplateRecord = createPromptTemplateRecord;
exports.createStyleProfileRecord = createStyleProfileRecord;
exports.saveAiRun = saveAiRun;
exports.updateAiRun = updateAiRun;
const firestore_1 = require("firebase-admin/firestore");
exports.AI_RUN_COLLECTIONS = Object.freeze({
    aiRuns: "ai_runs",
    aiCostPolicies: "ai_cost_policies",
    promptTemplates: "prompt_templates",
    styleProfiles: "style_profiles",
});
exports.AI_RUN_STATUSES = Object.freeze([
    "pending_approval",
    "approved",
    "running",
    "completed",
...
function estimateAiRunCost({ estimatedInputTokens = 0, estimatedOutputTokens = 0, estimatedCachedTokens = 0, pricing = {}, } = {}) {
    ...
    const estimatedInputCostUsd = calculateTokenCostUsd(normalizedInputTokens, pricing?.inputUsdPer1M);
    const estimatedOutputCostUsd = calculateTokenCostUsd(normalizedOutputTokens, pricing?.outputUsdPer1M);
    const estimatedCachedCostUsd = calculateTokenCostUsd(normalizedCachedTokens, pricing?.cachedInputUsdPer1M);
    return {
        ...
        estimatedCostUsd: Number((estimatedInputCostUsd + estimatedOutputCostUsd + estimatedCachedCostUsd).toFixed(6)),
    };
}
...
async function saveAiRun(record) {
    ...
    const docRef = db.collection(exports.AI_RUN_COLLECTIONS.aiRuns).doc();
    const data = {
        ...record,
        id: docRef.id,
...
async function updateAiRun(id, updates) {
    const db = (0, firestore_1.getFirestore)();
    const docRef = db.collection(exports.AI_RUN_COLLECTIONS.aiRuns).doc(id);
    const data = {
        ...updates,
...
//# sourceMappingURL=aiRuns.js.map