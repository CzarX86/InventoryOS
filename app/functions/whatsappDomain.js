const WHATSAPP_COLLECTIONS = Object.freeze({
...
const WHATSAPP_INSTANCE_STATUSES = Object.freeze([
  "pending",
  "active",
  "paused",
  "disconnected",
...
const WHATSAPP_EVENT_STATUSES = Object.freeze([
  "pending",
  "processing",
  "processed",
  "ignored",
...
const HISTORY_BACKFILL_JOB_STATUSES = Object.freeze([
  "pending",
  "running",
  "paused",
  "completed",
...
function buildWebhookEventDedupKey({
  provider = "evolution",
...
module.exports = {
  ...
  createWhatsappExtractedTransactionRecord,
};
