...
export const INSTALLED_BASE_SOURCES = Object.freeze([
  "confirmed",
  "inferred",
  "manual",
]);
...
export function buildCatalogItemCanonicalKey(payload = {}) {
  return [
    payload.type,
    payload.brand,
    payload.model,
...
export function createCatalogItemRecord(payload = {}, ownershipContext = {}) {
...
export function createInventoryItemRecord(payload = {}, ownershipContext = {}) {
...
export function createMaintenanceRuleRecord(payload = {}, ownershipContext = {}) {
...
export function createItemRelationshipRecord(payload = {}, ownershipContext = {}) {
...
export function canRecommendItemRelationship(relationship = {}) {
