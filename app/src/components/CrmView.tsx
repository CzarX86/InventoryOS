...
function followUpState(contact: Contact) {
  ...
  if (next < Date.now()) return { label: "Follow-up atrasado", className: "border-[#ee7d77]/30 bg-[#7f2927]/20 text-[#ee7d77]" };
    ...
    <div className="min-h-full bg-[#0e0e0e] pb-20 text-[#e7e5e5]">
      <div className="border-b border-[#484848]/20 bg-[#0e0e0e] px-4 py-10 md:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="mb-4 flex items-center gap-2"><Building2 size={15} className="text-[#97a5ff]" /><span className="font-mono text-[9px] uppercase tracking-[0.25em] text-[#acabaa]/50">CRM_WORKSPACE</span></div>
